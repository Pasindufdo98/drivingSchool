...
<div class="col-4">
      <div class="card bg-primary bg-gradient" style="width: 25rem;">
        <img src="light.jpg" class="card-img-top" alt="light.jpg"><div class="card-body">
              ...
              <ul class="list-group">
                  <li class="list-group-item">Bike Only: Rs.15000.000</li>
                  <li class="list-group-item">Manual Light Vehicles only: Rs.20000.000</li>
                  <li class="list-group-item">Auto Light Vehicles only: Rs.18000.000</li>
                  <li class="list-group-item">All light vehicles: Rs.35000.000</li>
                  <br/>
      ...
      <div class="card bg-secondary bg-gradient" style="width: 25rem;">
        <img src="3wheel.jpg" class="card-img-top" alt="open.jpg"><div class="card-body">
              ...
              <ul class="list-group">
                  <li class="list-group-item">Rs.12000.000</li>
