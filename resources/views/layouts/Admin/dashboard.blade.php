                  ...
                  <ul class="navbar-nav ps-3">
                    <li>
                      <a href="{{ route('users.index') }}" class="nav-link me-2 px-3">
                        <span class="px-2"> <i class="bi bi-person-add"></i></span><span> User Management</span></a>
                    </li>
                    <li>
                      <a href="{{ route('roles.index') }}" class="nav-link me-2 px-3">
                        <span class="px-2"><i class="bi bi-user"></i> </i></span><span> Role Management</span></a>
                    </li>
                    <li>
                      <a href="{{ route('products.index') }}" class="nav-link me-2 px-3">
                        <span class="px-2"><i class="bi bi-user"></i> </i></span><span> Vehicle Management</span></a>
                    </li>
                    <li>
                      <a href="{{ route('students.index') }}" class="nav-link me-2 px-3">
                        <span class="px-2"> <i class="bi bi-user"></i></span><span> Student Management</span></a>
                    </li>
                    <li class="my-4">
                      <hr class="dropdown-dividers">
                    </li>
